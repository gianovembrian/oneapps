 ...
 * @property \App\Model\Table\PdlnUserTable&\Cake\ORM\Association\HasMany $PdlnUser
 *
 * @method \App\Model\Entity\Pdln newEmptyEntity()
 * @method \App\Model\Entity\Pdln newEntity(array $data, array $options = [])
 * @method array<\App\Model\Entity\Pdln> newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\Pdln get(mixed $primaryKey, array|string $finder = 'all', \Psr\SimpleCache\CacheInterface|string|null $cache = null, \Closure|string|null $cacheKey = null, mixed ...$args)
 * @method \App\Model\Entity\Pdln findOrCreate($search, ?callable $callback = null, array $options = [])
 * @method \App\Model\Entity\Pdln patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method array<\App\Model\Entity\Pdln> patchEntities(iterable $entities, array $data, array $options = [])
 * @method \App\Model\Entity\Pdln|false save(\Cake\Datasource\EntityInterface $entity, array $options = [])
 * @method \App\Model\Entity\Pdln saveOrFail(\Cake\Datasource\EntityInterface $entity, array $options = [])
 * @method iterable<\App\Model\Entity\Pdln>|\Cake\Datasource\ResultSetInterface<\App\Model\Entity\Pdln>|false saveMany(iterable $entities, array $options = [])
 * @method iterable<\App\Model\Entity\Pdln>|\Cake\Datasource\ResultSetInterface<\App\Model\Entity\Pdln> saveManyOrFail(iterable $entities, array $options = [])
 * @method iterable<\App\Model\Entity\Pdln>|\Cake\Datasource\ResultSetInterface<\App\Model\Entity\Pdln>|false deleteMany(iterable $entities, array $options = [])
 * @method iterable<\App\Model\Entity\Pdln>|\Cake\Datasource\ResultSetInterface<\App\Model\Entity\Pdln> deleteManyOrFail(iterable $entities, array $options = [])
 *
 * @mixin \Cake\ORM\Behavior\TimestampBehavior
 */
class PdlnTable extends Table
{
    /**
     * Initialize method
     *
