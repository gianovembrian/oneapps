        ...
        <div class="card">
            <div class="card-header border-2">
                <div class="card-title">
                    <h2 class="">Daftar Pengajuan PDLN (Perjalanan Dinas Luar Negeri)</h2>
                </div>
                    ...
                    <table class="table align-middle table-row-dashed table-hover table-striped fs-6 gy-5 table-responsive" id="dataTables">
                        <thead>
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-150px">Pengaju</th>
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr>
                                <td><?= h($index + 1) ?></td>
                                <td>
                                    <div class="btn-group rad" role="group">
                                        <a class="btn btn-success btn-sm" href="/Pdln/view/<?=$pdln->id?>">
                                            <i class="bi bi-eye"></i> Detail
                                        </a>

                                        <?php if($role == 'superadmin' || $role == 'adminkepeg'){
                                            ?>
                                            <a class="btn btn-primary btn-sm" href="/Pdln/review/<?=$pdln->id?>">
                                ...
                                <td><?php 
									$date = new DateTime($pdln->created);
                                 ...
                                 <td>
                                    ...
                                    <Br />
                                    <small><?php
                                    $date = new DateTime($pdln->approval_date);
                                ...
                                <td>
                                        ...
                                        <?php if (!empty($pdln->pdln_user)) : ?>
                                            <?php foreach ($pdln->pdln_user as $employee) : ?>
                                                ...
                                                <small><?= h($employee->nama_unit_kerja) ?></small> <br />
                                ...
                                <td>
                                    <?php 
                                        echo '<b>'.$pdln->user->name.'</b><br />'.$pdln->user->unit ?>
                                </td> 
                                ...
                                <td>
                                	 <div class="btn-group btn-rounded" role="group" aria-label="">
                                        <a class="btn btn-warning btn-sm" href="/Pdln/edit/<?=$pdln->id?>">
                                            <i class="bi bi-pencil"></i> 
                                        </a>
                                        <a class="btn btn-danger btn-sm" href="/Pdln">
